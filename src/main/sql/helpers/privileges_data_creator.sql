--data creator missing privilege if anything returned
----https://pro.arcgis.com/en/pro-app/help/data/geodatabases/manage-oracle/privileges-oracle.htm
select regexp_substr('CREATE SEQUENCE,CREATE SESSION,CREATE TABLE,CREATE TRIGGER,CREATE VIEW','[^,]+', 1, level) 
    from dual
